...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/book.jpg');?>')no-repeat;background-size:99%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">Sistem Informasi <br/><b>Perpustakaan STMIK Palangkaraya</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Sistem Perpustakaan STMIK Palangkaraya - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
